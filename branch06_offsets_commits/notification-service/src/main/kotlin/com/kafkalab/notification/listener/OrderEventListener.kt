...
class OrderEventListener(
    ...
    private val redeliveredCount = AtomicInteger(0)
    ...
    @KafkaListener(topics = ["06.orders.cancelled"], groupId = "notification-service-group")
    ...
    fun getRedeliveredCount(): Int = redeliveredCount.get()
