...
class OrderService(private val kafkaTemplate: KafkaTemplate<String, SpecificRecord>) {
    ...
    fun createOrder(userId: String, itemCount: Int = 2): String {
        ...
        kafkaTemplate.send("11.orders.created", orderId, event)
        log.info("[PRODUCER] OrderCreated — orderId={} userId={} items={} total={}",
    ...
    fun cancelOrder(orderId: String, userId: String, reason: String) {
        ...
        kafkaTemplate.send("11.orders.cancelled", orderId, event)
        log.info("[PRODUCER] OrderCancelled — orderId={} reason={}", orderId, reason)
    }
}